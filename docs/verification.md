...
Every row was run against this tree on 2026-09-07 (Node v24.15.0, npm 11.12.1, bun 1.3.14, macOS 26.5.1). `npm run release:check` runs all of them in order, plus a bundle step, and takes about **2.5–3 minutes** on that stack — around nine tenths of it the mutation rung, which re-runs the whole suite once per mutant. (Timed end to end: 150 s, 151 s, 155 s and 173 s before 1.0.0, and 153 s, 157 s and 162 s on the 1.0.0 tree, which adds 47 tests and three mutants.)
