...
- Add `GoalPlan`, `GoalPlanAction`, `GoalPlanActionStatus`, `GoalPlanVerdict`, and `GoalSidebarStatus` to the published type declarations, along with `sidebarStatus` and the goal's `objectiveLabel`/`plan` fields.
